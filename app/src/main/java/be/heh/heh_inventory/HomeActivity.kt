...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        val permission : DatabasePermission = intent.getSerializableExtra("user_permission") as DatabasePermission
        val userMail : String? = intent.getStringExtra("user_email")

        // Change mail in navigation drawer
        val userEmailText = findViewById<TextView>(R.id.nav_user_email)
        userEmailText.text = userMail

        // Hide menus if the user does not have permissions
        if (permission == DatabasePermission.READ){
            findViewById<View>(R.id.nav_device_add).isVisible = false
        }
